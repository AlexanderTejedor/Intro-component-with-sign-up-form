...
const Home = () => {
    return (
        <section className='container relative bg-red-74 w-full p-5 text-white flex items-center flex-col max-w-full'>
            <figure className=''>
            ...
            <article className='text-center my-10 pb-6 max-w-130'>
            ...
            <article className='z-10 flex flex-col items-center'>
                ...
                <form className='z-100 relative bg-white text-darkBlue-26 p-6 mb-11 rounded-lg shadow-[0px_8px_0px_0px_rgba(0,_0,_0,_0.15)] min-[425px]:mb-25 max-w-130'>
