...
const Home = () => {
    return (
        <section className='container bg-red-74 w-full p-5 text-white'>
            ...
            <article className='text-center my-10 pb-6'>
            ...
            <article className='z-10'>
                <div className='relative text-center bg-blue-49 p-4 mb-8 z-30 rounded-lg shadow-[0px_8px_0px_0px_rgba(0,_0,_0,_0.15)]'>
                ...
                <form className='z-100 relative bg-white text-darkBlue-26 p-6 mb-11 rounded-lg shadow-[0px_8px_0px_0px_rgba(0,_0,_0,_0.15)]'>
                    ...
                    <button className='bg-green-51 w-full text-white py-4 rounded-md font-medium mb-4 cursor-pointer' type="submit" value="">CLAIM YOUR FREE TRIAL</button>
